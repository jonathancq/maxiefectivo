...
(function(){var e,a=1;$(function(){return $("#btn").on("click",function(){1==a?($("nav").animate({left:"0"}),a=0):(a=1,$("nav").animate({left:"-100%"}))}),$(".rslides").responsiveSlides({auto:!0,speed:1e3}),$("#name").filter_input({regex:"[a-z A-Z ñÑ áéíóú]"}),$("#dni, #phone").filter_input({regex:"[0-9]"}),$("form input[type='button']").on("click",function(){return $("form").valid()===!0&&($(this).off("click"),$.ajax({type:"post",url:site+"home/validate",dataType:"json",data:{name:$("#name").val(),dni:$("#dni").val(),phone:$("#phone").val(),agencias:$("#agencias").val(),prestamo:$("#prestamo").val(),detalles:$("#detalles").val()},success:function(a){return 0==a.print?(e="",e+="<p>Lo sentimos, pero hay un problema con el envío. Inténtelo más tarde.</p>",$("article.fila1 > div").fadeOut("slow",function(){$(this).html(e).fadeIn("slow")})):(e="",e+="<h2>¡Correo enviado! Muchas gracias.</h2>",e+="<p>Te confirmamos que hemos recibido tu consulta, nos pondremos en contacto contigo a la brevedad.<br /><br />Mientras tanto…</p>",e+="<ul>",e+='<li>¡Súmate a nuestros seguidores en <a href="https://www.facebook.com/MaxiefectivoPeru/" target="_blank">Facebook</a> y <a href="https://twitter.com/MaxiefectivoPE" target="_blank">Twitter</a>. Quédate en contacto para enterarte de las últimas promociones.</li>',e+="<li>Te recordamos que nuestra central telefónica es (01) 419 8888.</li>",e+='<li>Puedes visitarnos en cualquiera de nuestras 11 agencias en el país. Conoce más <a href="'+site+'agencias">haciendo click aquí</a>.</li>',e+="</ul>",$("article.fila1 > div").fadeOut("slow",function(){$(this).html(e).fadeIn("slow")}))}})),!1}),$("form").validate({ignore:"not:hidden, .ignore",rules:{name:{required:!0,minlength:2},dni:{required:!0,minlength:8,maxlength:8},phone:{required:!0,minlength:7,maxlength:9},agencias:{required:!0},prestamo:{required:!0},detalles:{required:!0,minlength:2}},messages:{name:{required:"",minlength:""},dni:{required:"",minlength:"",maxlength:""},phone:{required:"",minlength:"",maxlength:""},agencias:{required:""},prestamo:{required:""},detalles:{required:"",minlength:""}}})})}).call(this);